...
def main():
    ...
    parser.add_argument(
        "--models_dir", type=str, required=True, help="Directory with trained models"
    )
    parser.add_argument(
    ...
    for model_name in model_names:
        ...
        calibrator_save_path = os.path.join(
            args.save_dir, "calibrators", f"{model_name}_calibrator.pth"
        )
        ...
        save_calibrated_probs(
            ...
            cal_loader,
            group_info,
            os.path.join(prob_save_dir, "cal.pth"),
            device,
        )
        save_calibrated_probs(
            model,
            ...
            val_loader,
            group_info,
            os.path.join(prob_save_dir, "val.pth"),
            device,
        )
        save_calibrated_probs(
            model,
            ...
            test_loader,
            group_info,
            os.path.join(prob_save_dir, "test.pth"),
            device,
        )
